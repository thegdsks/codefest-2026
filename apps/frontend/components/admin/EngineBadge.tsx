  ...
  if (layer === 'L1+L2') {
    return (
      <span className="inline-flex items-center gap-1.5">
        <span className="inline-flex items-center gap-1 rounded-full bg-indigo-500/20 border border-indigo-400/40 px-2 py-0.5 text-xs font-medium text-indigo-100">
          <Sparkle size={11} />
          L1+L2
        </span>
