        ...
        {CHIPS.map((chip) => {
          ...
          return (
            <button
              ...
              className={
                isActive
                  ? 'relative inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold text-white before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-r before:from-indigo-500 before:to-fuchsia-500 before:-z-10 bg-gradient-to-r from-indigo-500 to-fuchsia-500 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400/70 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950'
