...
// src/react/EngagementProvider.tsx
...
function NudgeBanner({ intervention, onDismiss, theme }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: bannerStyle, role: "alert", "aria-live": "polite", children: [
    /* @__PURE__ */ jsx("p", { style: messageStyle, children: intervention.message }),
    /* @__PURE__ */ jsxs("div", { style: actionsStyle, children: [
      intervention.ctaUrl && intervention.ctaLabel && /* @__PURE__ */ jsx(
        "a",
        {
      ...
      /* @__PURE__ */ jsx("button", { style: dismissStyle, onClick: onDismiss, "aria-label": "Dismiss", children: "\u2715" })
    ] })
  ] });
}
var defaultTheme2 = {
...
function OfferModal({ intervention, onDismiss, theme }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: overlayStyle, role: "dialog", "aria-modal": "true", "aria-label": "Offer", children: /* @__PURE__ */ jsxs("div", { style: modalStyle, children: [
    /* @__PURE__ */ jsx("button", { style: closeButtonStyle, onClick: onDismiss, "aria-label": "Close", children: "\u2715" }),
    /* @__PURE__ */ jsx("h2", { style: headingStyle, children: intervention.message }),
    intervention.metadata?.description && /* @__PURE__ */ jsx("p", { style: bodyStyle, children: String(intervention.metadata.description) }),
    /* @__PURE__ */ jsxs("div", { style: actionsStyle, children: [
      /* @__PURE__ */ jsx("button", { style: secondaryButtonStyle, onClick: onDismiss, children: "Not now" }),
      intervention.ctaUrl && intervention.ctaLabel && /* @__PURE__ */ jsx("a", { href: intervention.ctaUrl, style: primaryButtonStyle, children: intervention.ctaLabel })
    ] })
  ] }) });
}
var defaultTheme3 = {
...
function HelpTooltip({ intervention, onDismiss, theme }) {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: tooltipRef, style: tooltipStyle, role: "tooltip", children: [
    /* @__PURE__ */ jsx("div", { style: arrowStyle }),
    /* @__PURE__ */ jsx("p", { style: messageStyle, children: intervention.message }),
    /* @__PURE__ */ jsxs("div", { style: actionsStyle, children: [
      intervention.ctaUrl && intervention.ctaLabel && /* @__PURE__ */ jsx("a", { href: intervention.ctaUrl, style: ctaStyle, children: intervention.ctaLabel }),
      /* @__PURE__ */ jsx("button", { style: dismissStyle, onClick: onDismiss, children: "Got it" })
    ] })
  ] });
}
var EngagementContext = createContext(null);
...
function EngagementProvider({
  ...
  useEffect(() => {
    ...
    const capture = mountCapture((event) => {
  ...
  const trackHealthyEvent = useCallback((eventKey) => {
  ...
  function renderSurface() {
    ...
    if (CustomComponent) {
      return /* @__PURE__ */ jsx(CustomComponent, { intervention: currentIntervention, onDismiss: dismiss });
    }
    if (surfaceType === "nudge_banner") {
      return /* @__PURE__ */ jsx(NudgeBanner, { intervention: currentIntervention, onDismiss: dismiss });
    }
    if (surfaceType === "offer_modal") {
      return /* @__PURE__ */ jsx(OfferModal, { intervention: currentIntervention, onDismiss: dismiss });
    }
    if (surfaceType === "help_tooltip") {
      return /* @__PURE__ */ jsx(HelpTooltip, { intervention: currentIntervention, onDismiss: dismiss });
    }
    return null;
  }
...
export { EngagementProvider, useEngagement };
